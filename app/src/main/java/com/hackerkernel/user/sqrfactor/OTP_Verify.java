...
//                Toast.makeText(OTP_Verify.this, pinview.getValue(), Toast.LENGTH_SHORT).show();
        ...
        validate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StringRequest myReq = new StringRequest(Request.Method.POST, "https://archsqr.in/api/verify_otp",
   ...
   public void ResendOTP(){
       RequestQueue requestQueue = Volley.newRequestQueue(getApplicationContext());
       StringRequest myReq = new StringRequest(Request.Method.POST, "https://archsqr.in/api/resendotp",
               new Response.Listener<String>() {
                   @Override
                   public void onResponse(String response) {
                       Log.v("Reponse", response);
